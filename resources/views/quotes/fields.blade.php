...
{{--                             {{ Form::select('product_id[]', $products, null, ['class' => 'form-select product-quote io-select2', 'required', 'placeholder' => __('messages.flash.select_product_or_enter_free_text'), 'data-control' => 'select2']) }}--}}
                            {{ Form::text('product_name[]', null, ['class' => 'form-control form-control-solid', 'required', 'placeholder' => __('messages.flash.select_product_or_enter_free_text'), 'data-control' => 'select2']) }}
                        </td>
                        <td class="table__qty">
                ...
                <div class="mb-2 col-xl-6 col-lg-10 col-sm-12 float-right">
                    ...
                    <div class="input-group">
                        ...
                        <div class="input-group-append" style="width: 210px !important;">
                            {{ Form::select('discount_type', getTranslatedData($discount_type), 0, ['class' => 'form-select io-select2', 'id' => 'discountType', 'data-control' => 'select2']) }}
                        </div>
                    </div>
                </div>
            </div>
