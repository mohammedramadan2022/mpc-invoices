                ...
                <table class="my-3 w-100">
                    ...
                    <tr style="vertical-align:top;">
                        <td width="43.33%;">
                            ...
                            <p class=" mb-1 font-color-gray fs-6">{{ __('messages.client.client_name') . ':' }} <span
                                    class="font-gray-900">{{ $client->company_name }}</span></p>
                            <p class=" mb-1 font-color-gray fs-6">{{ __('messages.client.attention') . ':' }} <span
            ...
            <div class="mt-20">
                @if($quote->note)
                    <div class="mb-5 pt-10">
                        <h6 class="font-gray-900 mb5 text-start"><b>{{ __('messages.client.notes') . ':' }}</b></h6>
                ...
                <table class="mb-3 w-100">
                    <tr>
                        ...
                        <td class="w-25 text-start">
                            <div class="">
                                <h6 class="font-dark-gray mb5"><b>{{ __('messages.setting.regards') . ':' }}</b></h6>
