...
class QuoteTable extends LivewireTableComponent
{
    ...
    public $listeners = ['changeQuoteStatusFilter', 'resetPageTable', 'changeDateRangeFilter', 'changeClientFilter'];
    ...
    public function builder(): Builder
    {
        ...
        $query->when($this->selectedClient, function ($query) {
    ...
    public function changeClientFilter($clientId)
    {
    ...
    {
        return view('livewire.invoice_listing_skeleton');
    }
}
